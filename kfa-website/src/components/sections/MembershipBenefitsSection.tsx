    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-primary-600 to-primary-800 py-24">
      ...
      <div className="container relative">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {benefits.map((benefit) => {
              ...
              return (
                <div
                  key={benefit.key}
                  className="group relative overflow-hidden rounded-kfa border border-primary-400/30 bg-white/10 p-6 backdrop-blur-sm transition-all hover:bg-white/20 hover:shadow-kfa-lg"
                >
                  <div className="mb-4 inline-flex rounded-lg bg-white p-3 text-primary-700 shadow-kfa-md">
        ...
        <div className="mt-16 text-center">
          <a
            href="/membership"
            className="inline-flex items-center gap-2 rounded-lg bg-accent-600 px-8 py-4 font-semibold text-white shadow-kfa-lg transition-all hover:bg-accent-700 hover:shadow-kfa-xl"
          >
            {t('benefits.cta')}
