...
(function () {
  ...
  window.showLoading = function () {
    ...
    loader.style.cssText = `
        ...
        `;
    loader.innerHTML =
      '<div class="spinner" style="border: 4px solid #f3f3f3; border-top: 4px solid #003366; border-radius: 50%; width: 50px; height: 50px; animation: spin 1s linear infinite;"></div>';
